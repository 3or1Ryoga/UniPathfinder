        ...
        <div style={{
            ...
            <div style={{
                ...
                <button
                    ...
                    disabled={loading || !lineAddFriendUrl}
                    style={{
                        width: '100%',
                        padding: '16px 24px',
                        ...
                        fontSize: '16px',
                        fontWeight: 'bold',
                        cursor: (loading || !lineAddFriendUrl) ? 'not-allowed' : 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        gap: '12px',
                        transition: 'background-color 0.2s ease',
                        opacity: (loading || !lineAddFriendUrl) ? 0.7 : 1,
                        marginBottom: '1rem'
                    }}
                    onMouseOver={(e) => !loading && lineAddFriendUrl && (e.currentTarget.style.backgroundColor = '#05b04b')}
                    onMouseOut={(e) => !loading && lineAddFriendUrl && (e.currentTarget.style.backgroundColor = '#06C755')}
                >
