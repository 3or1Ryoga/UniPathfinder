            ...
            <div className="lg:hidden space-y-6 w-full">
              ...
              <div className="flex flex-col gap-4">
                ...
                <button
                  onClick={handleGoogleLogin}
                  disabled={loading || googleLoading}
                  className="w-full px-6 py-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-xl font-semibold border-2 border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
                >
                  <svg height="20" width="20" viewBox="0 0 24 24">
                    <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                    <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              >
                <summary className="cursor-pointer font-semibold text-lg text-gray-900 list-none flex items-center justify-between">
                  <span>{faq.q}</span>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <button
              onClick={handleGitHubLogin}
              disabled={loading || googleLoading}
              className="inline-block px-12 py-5 bg-white text-blue-600 font-bold rounded-xl hover:bg-gray-100 transition-all shadow-2xl text-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
