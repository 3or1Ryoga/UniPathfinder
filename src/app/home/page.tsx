          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="flex items-start gap-3 sm:gap-6 flex-1">
                  ...
                  >
                    {displayProfile?.avatar_url ? (
                      <img
                        ...
                        alt="プロフィール写真"
                        className="w-20 h-20 sm:w-32 sm:h-32 rounded-full object-cover border-2 sm:border-4 border-gray-200 group-hover:border-blue-500 transition-all aspect-square"
                      ...
                      <div className="w-20 h-20 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-2xl sm:text-4xl font-bold border-2 sm:border-4 border-gray-200 group-hover:border-blue-500 transition-all aspect-square">
                  ...
                  <div className="relative block">
                    {displayProfile?.avatar_url ? (
                      <img
                        src={displayProfile.avatar_url}
                        alt="プロフィール写真"
                        className="w-20 h-20 sm:w-32 sm:h-32 rounded-full object-cover border-2 sm:border-4 border-gray-200 aspect-square"
                      />
                    ) : (
                      <div className="w-20 h-20 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-2xl sm:text-4xl font-bold border-2 sm:border-4 border-gray-200 aspect-square">
                        {getInitials(displayProfile?.full_name)}
                      </div>
                    )}
                  </div>
              ...
              <div className="flex-1 min-w-0">
                  ...
                  {isEditingName && isOwnProfile ? (
                    <div className="flex items-center gap-1 sm:gap-2 w-full">
                      <input
                        ...
                        className="text-lg sm:text-2xl font-bold text-gray-800 border-b-2 border-blue-500 outline-none bg-transparent w-full"
                        autoFocus
                      />
                      <button
                        onClick={handleSaveName}
                        className="text-green-600 hover:text-green-700 text-sm sm:text-base flex-shrink-0"
                      >
                        ✓
                      </button>
                      <button
                        ...
                        className="text-red-600 hover:text-red-700 text-sm sm:text-base flex-shrink-0"
                      >
                        ✕
                      </button>
                    </div>
                ...
                {/* ユーザーID */}
                <p className="text-gray-500 text-xs sm:text-sm mb-0.5 sm:mb-1 truncate">@{displayProfile?.id.substring(0, 17)}</p>
                ...
                {isEditingSchool && isOwnProfile ? (
                  <div className="flex items-center gap-1 sm:gap-2 mb-2">
                    <input
                      ...
                      className="text-xs sm:text-base text-gray-700 border-b border-blue-500 outline-none bg-transparent w-full"
                      autoFocus
                    />
                    <button
                      onClick={handleSaveSchool}
                      className="text-green-600 hover:text-green-700 text-xs sm:text-sm flex-shrink-0"
                    >
                      ✓
                    </button>
                    <button
                      ...
                      className="text-red-600 hover:text-red-700 text-xs sm:text-sm flex-shrink-0"
                    >
                      ✕
                    </button>
                  </div>
                  ...
                  <div className="flex items-center gap-1 sm:gap-2 group mb-2">
                    <p className="text-xs sm:text-base text-gray-700 truncate">{displayProfile?.education || '学校未設定'}</p>
                    {isOwnProfile && (
                      <button
                ...
                <p className="text-xs sm:text-base text-gray-600 font-medium">
                  つながり <span className="font-bold text-gray-800">{connectionsCount}人</span>
                </p>
              </div>
            </div>
            ...
            <div className="text-left sm:text-right border-t sm:border-t-0 pt-3 sm:pt-0 flex items-center justify-between sm:block">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs sm:text-sm text-gray-500">一般公開</span>
              </div>
              <div className="text-right">
                <p className="text-xs sm:text-sm text-gray-600">プロフィールが見られた数</p>
                <p className="text-2xl sm:text-4xl font-bold text-gray-800">0<span className="text-sm sm:text-lg">回</span></p>
                <p className="text-[10px] sm:text-xs text-gray-400">(近日実装予定)</p>
              </div>
            </div>
          </div>
        </div>
        ...
        */}
        ...
        <div className="mt-8">
          ...
          <div className="mb-6 text-center sm:text-left">
            {/* <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">あなたのことをもっと教えてください</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-8 p-2 sm:p-6">
                ...
                {blogPosts.map((post) => (
                  <div
                    ...
                    className="bg-white rounded-2xl overflow-visible hover:shadow-2xl relative border border-gray-200 group"
                  >
                    {/* 編集・削除ボタン */}
                    {isOwnProfile && (
                      <div className="absolute top-3 right-3 z-20 hidden sm:flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          ...
                          className="bg-white text-red-500 rounded-full p-2 shadow-lg hover:bg-red-50 transition-colors"
                          title="削除"
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="absolute -top-4 -left-4 z-10 hidden sm:block">
                      <span className="inline-block px-5 py-3 bg-gray-500/60 backdrop-blur-sm text-white rounded-2xl text-base font-bold shadow-xl transform rotate-[-5deg] hover:rotate-0 transition-transform duration-300">
                        {post.topic}
                      </span>
                    </div>
                    ...
                    <div className="w-full aspect-square sm:aspect-[16/9] relative overflow-hidden rounded-2xl sm:rounded-t-2xl">
                      ...
                      <div className="absolute bottom-1 right-1 sm:bottom-3 sm:right-3 flex items-center gap-1 sm:gap-3">
                        ...
                        <button
                          ...
                          className="flex items-center gap-0.5 sm:gap-1.5 bg-white/95 backdrop-blur-sm rounded-full px-1.5 py-1 sm:px-3 sm:py-1.5 shadow-lg hover:shadow-xl transition-all hover:scale-110"
                        >
                          <svg
                    ...
                    <div className="p-4 hidden sm:block">
                      {/* タイトル */}
                      <h3 className="font-bold text-gray-900 mb-2 text-base line-clamp-2 leading-tight">{post.title}</h3>

                      {/* 本文（プレビュー） */}
                      <p className="text-gray-600 text-sm mb-3 line-clamp-4 leading-relaxed">{post.content}</p>
                      ...
                      {post.reference_url && (
                        <a
                          ...
                          className="block mb-3 p-2 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors"
                        >
                          <div className="flex items-center gap-2">
                            <svg className="w-4 h-4 text-blue-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                            </svg>
                            <span className="text-sm text-blue-600 truncate font-medium">{new URL(post.reference_url).hostname}</span>
                          </div>
                        </a>
                      )}
                ...
                {isOwnProfile && (
                  <button
                    ...
                    className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border-2 border-dashed border-gray-300 hover:border-blue-500 hover:from-blue-50 hover:to-indigo-50 transition-all flex flex-col items-center justify-center aspect-square sm:min-h-[320px] sm:aspect-auto group"
                  >
                    ...
                    <p className="text-xs sm:text-base font-bold text-gray-800 group-hover:text-blue-700 transition-colors">投稿を作成</p>
                    <p className="text-[10px] sm:text-sm text-gray-500 mt-1 sm:mt-2 text-center px-2 sm:px-4">今日のあなたをシェアしよう</p>
                  </button>
                )}
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-4 border border-blue-100 sticky top-4 overflow-hidden">
                <div className="flex items-center gap-2 mb-4">
                  <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  <h3 className="font-bold text-gray-800">皆の小さなテックブログ</h3>
                </div>
                            ...
                            {post.cover_image_url ? (
                              ...
                              <div className={`w-full h-full ${getTopicPlaceholder(post.topic)} flex items-center justify-center p-4`}>
                                ...
                                {hoveredPostId === `left-${post.id}-${index}` && (
                                  <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center p-2 transition-opacity duration-300">
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <button
                                        ...
                                        className="flex items-center gap-1 bg-white/90 backdrop-blur-sm rounded-full px-2 py-1 shadow-lg hover:bg-white transition-all"
                                      >
                                        <svg
                                  ...
                                  {/* タイトル */}
                                  <div className="p-2">
                                    <h4 className="font-bold text-gray-800 text-xs line-clamp-2 leading-tight">
                                      {post.title}
                                    </h4>
                                  </div>
                                </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                {/* ヘッダー */}
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-2xl font-bold text-gray-800">テックブログを投稿</h3>
                  <button
                    onClick={() => {
                      setIsCreatingPost(false)
                      setNewPost({
                ...
                <div className="mb-4">
                  ...
                  {coverPreview ? (
                    ...
                    <button
                      ...
                      className="w-full aspect-[16/9] border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 transition-colors flex flex-col items-center justify-center gap-2 bg-gray-50 hover:bg-blue-50"
                    >
                      {uploadingCover ? (
                        ...
                        <>
                          ...
                          <span className="text-xs text-gray-400">横長の画像を推奨（5MB以下）</span>
                        </>
                      )}
                    </button>
                  )}
                ...
                <div className="mb-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-sm font-medium text-gray-700">参照URLを追加</span>
                  </label>
                </div>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <h3 className="text-2xl font-bold text-gray-800">コメント</h3>
                <button
                  onClick={closeCommentModal}
